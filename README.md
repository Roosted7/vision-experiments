...
```
uv run camera_detect.py --model yolo26s-320 --show-fps --image testdata/good_cam1_person.webp && open result.jpg 
uv run camera_detect.py --model yolo26m-320-uint8 --show-fps --image testdata/good_cam1_person.webp && open result.jpg
```
